package com.lucio.api.shopping.shopping_api.converter;
...
public class DTOConverter {
    public static ShopDTO fromModel(Shop shopping) {
        ...
        return new ShopDTO(shopping.getId(),shopping.getUserIdentifier(),shopping.getDate(), itemsDTO, shopping.getTotal());
    }
